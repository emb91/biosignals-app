-- Add logo_cached column to companies for storing a locally-cached base64
-- copy of the LinkedIn CDN logo (signed URLs expire; cached copy never does).
ALTER TABLE companies ADD COLUMN IF NOT EXISTS logo_cached TEXT;

-- Update list_user_accounts RPC to expose logo_cached alongside logo_url.
