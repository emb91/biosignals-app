...
export default function SignalsPage() {
            ...
            <div className="flex flex-col items-center max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="hidden md:block">
                  <div className="relative w-full max-w-[800px] mx-auto aspect-[4/3] transform scale-75 md:scale-90 lg:scale-100">
                    {/* Left side - Query Builder */}
                    <div className="absolute top-0 left-[-80px] md:left-[-120px] lg:left-[-140px] w-[350px] md:w-[380px] lg:w-[400px]">
                    ...
                    {/* Right side - Results */}
                    <div className="absolute top-[23px] left-[140px] md:left-[160px] lg:left-[180px] right-[-120px] md:right-[-140px] lg:right-[-160px]">
        ...
        <div className="w-full bg-white">
          <div className="container mx-auto px-4 md:px-6 pt-16 md:pt-28">
            ...
            >
              ...
              <p className="text-lg text-arcova-darkblue/70 max-w-3xl mx-auto max-w-[900px] leading-relaxed">
              We automate the processes that slow down growth, creating systems that allow your sales teams to sell.
              </p>
            </motion.div>
          </div>
  ...
  <AnimatedSection id="always-on-intelligence" className="w-full py-24 md:py-32 bg-slate-50">
          <div className="container px-4 md:px-6 max-w-5xl">
            <div className="text-center mb-16">
              {/* <div className="inline-block px-3 py-1 bg-arcova-mint/30 text-arcova-teal rounded-full text-sm font-medium mb-6">
              Signal Strategy & Targeting
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="relative w-full max-w-[500px] mx-auto lg:mx-0 shadow-xl rounded-2xl overflow-hidden order-1 lg:order-1 aspect-[4/3]">
                <Image
              ...
              <div className="space-y-3 max-w-[500px] mx-auto lg:mx-0 lg:max-w-none">
                <div className="space-y-6 mb-6">
                  <div className="flex items-start gap-3">
                    <div className="rounded-full bg-arcova-teal p-1 mt-1 flex-shrink-0">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
 ...
 {/* <div className="w-full pt-0 pb-16 bg-gradient-to-b from-white to-gray-50/30">
        ...
        <AnimatedSection className="w-full py-24 md:py-24 bg-white">
          <div className="container px-4 md:px-6 max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-arcova-darkblue mb-6 text-center">
          ...
          <div className="container px-4 md:px-6 max-w-[850px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 mb-16">
              ...
              <div className="flex flex-col items-center text-left">
                ...
                <h2 className="text-xl font-bold text-arcova-darkblue mb-2">Emma Bardsley, PhD</h2>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="text-xl font-bold text-arcova-darkblue mb-2">Peter Sloan</h2>
                <div className="flex items-center gap-3">
                  <a 
