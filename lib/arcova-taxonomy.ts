export const COMPANY_TYPE_OPTIONS = [
  ...
  { value: 'Pharma', description: 'Large established pharmaceutical companies' },
  {
    ...
    description: 'University-originated companies and research institutes',
  },
  {
    value: 'CDMO',
  ...
  },
  {
    ...
    description: 'Technology platforms, discovery tools, data products, or enabling infrastructure',
  },
] as const;
