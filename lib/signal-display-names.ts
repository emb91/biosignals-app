export const SIGNAL_DISPLAY_NAMES: Record<string, string> = {
  ...
  ipo_or_follow_on: 'IPO or follow-on financing',
  ...
  terminated_deal: 'Deal or agreement terminated',
  ...
  principal_investigator_new_trial: 'PI on new clinical trial',
  award_or_recognition: 'Award or recognition',
  patent_filed_or_granted: 'Patent filed or granted',
  patent_application_published: 'Patent application published',
  patent_granted: 'Patent granted',
  new_therapeutic_area_patent: 'New therapeutic area patent',
  assignee_portfolio_acceleration: 'Patent portfolio acceleration',
