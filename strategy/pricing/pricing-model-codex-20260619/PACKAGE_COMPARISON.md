...
| Sequence generation | 2/month | 95/month | 300/month | Custom |
...
| Sequence generation | - | 1,140 upfront | 3,600 upfront | Custom |
...
| Company-only enrichment | 3 | Setup-time company mapping is free. |
...
| Seven-touch outreach sequence | 5 | Extra sequences use credits. Each generated sequence has 7 steps before edits: 4 email, 1 LinkedIn add, and 2 LinkedIn messages. |
...
- Starter's 95 generated sequences/month equal 665 total steps: 380 email, 95 LinkedIn adds, and 190 LinkedIn message steps before edits.
- Growth's 300 generated sequences/month equal 2,100 total steps: 1,200 email, 300 LinkedIn adds, and 600 LinkedIn message steps before edits.
...
- `18 / 95 sequences generated this month`
